...
<?php wp_head(); ?>
<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/assets/css/LinenAlley.min.css" />
</head>
			...
			<nav role="navigation">
				<div class="main-menu navbar navbar-default">
					...
					<!-- display site title in mobile menu -->
						<a class="navbar-brand visible-xs-inline-block" href="<?php echo esc_url( home_url() ) ?>/" title="<?php bloginfo( 'name' ) ?>" rel="homepage">Menu <?php //bloginfo( 'name' ) ?></a>
					</div>
