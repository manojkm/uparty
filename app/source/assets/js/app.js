...
var appMaster = {
  ...
  rangeSlider: function () {
    ...
    var slider = $('.range-right'),
      range = $('.range-right > .range-slider__range'),
      value = $('.range-right > .range-slider__value');
  ...
  rangeSliderProgress: function () {
    const allRanges = document.querySelectorAll(".range-progress");
    allRanges.forEach(wrap => {
      const range = wrap.querySelector(".range-progress > .range-slider__range");
      const value = wrap.querySelector(".range-progress > .range-slider__value");
    ...
    function setBubble(range, value) {
      ...
      value.style.left = `calc(${newVal}% + (${8 - newVal * 0.15}px))`;
    }
  },
...
$(document).ready(function () {
  ...
  appMaster.rangeSlider();
  appMaster.rangeSliderProgress();
