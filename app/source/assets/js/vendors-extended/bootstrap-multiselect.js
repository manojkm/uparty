...
$(document).ready(function () {
    ...
    $('.bs-multiselect-4').multiselect({
       ...
       // buttonWidth: '100%',
        ...
        templates: {
            ul: '<ul class="multiselect-container dropdown-menu extended"></ul>',
            filter: '<li class="multiselect-item filter"><div class="input-group input-group-sm"><div class="input-group-prepend"><span class="input-group-text text-dark bg-light"><i class="icon-magnifier"></i></span></div><input class="form-control multiselect-search text-dark border-light " type="text"></div></li>',
